...
namespace CP.Data.Migrations
{
    ...
    [Migration("20240621190250_addColumn_AvailabilityStatus_UserTable")]
    partial class addColumn_AvailabilityStatus_UserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CP.Models.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CP.Models.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CP.Models.Entities.Conversation", b =>
                {
                    b.HasOne("CP.Models.Entities.ApplicationUser", "User1")
                        .WithMany("ConversationsAsUser1")
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CP.Models.Entities.ApplicationUser", "User2")
            ...
            modelBuilder.Entity("CP.Models.Entities.FriendRequest", b =>
                {
                    b.HasOne("CP.Models.Entities.ApplicationUser", "ReceiverUser")
                        .WithMany("FriendRequestReceiver")
                        .HasForeignKey("ReceiverUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CP.Models.Entities.ApplicationUser", "SenderUser")
            ...
            modelBuilder.Entity("CP.Models.Entities.Message", b =>
                {
                    ...
                    b.HasOne("CP.Models.Entities.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CP.Models.Entities.ApplicationUser", null)
                        .WithMany()
